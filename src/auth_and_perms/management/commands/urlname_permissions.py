URLNAME_PERMISSIONS = {
    ...
    "labindex": [
        ...
        },
        {
            ...
            "permission": "laboratory.view_laboratory_process",
        },
    ],
    "list_provider": [
        {
    ...
    "organizationManager": [
        ...
        {"name": "Add User", "category": "User", "permission": "auth.add_user"},
        {"name": "Change User", "category": "User", "permission": "auth.change_user"},
        {"name": "View User", "category": "User", "permission": "auth.view_user"},
        {
        ...
        {"name": "View MSDS", "category": "MSDS", "permission": "msds.view_msdsobject"},
        {
    ...
    "index": [
        ...
        {"name": "View Label", "category": "Label", "permission": "sga.view_label"},
        {
    ...
    "step_three": [
        ...
        {"name": "Add Label", "category": "Label", "permission": "sga.add_label"},
        {
            "name": "Change Display Label",
            "category": "Display Label",
            "permission": "sga.change_displaylabel",
    ...
    "regent_crud": [
        ...
        {"name": "View Users", "category": "User", "permission": "auth.view_user"},
        {
            "name": "Add Regent",
            "category": "Regent",
            "permission": "risk_management.add_regent",
    ...
    "laboratory_process_list": [
        ...
        {
            "name": "Update Laboratory Process",
            "category": "Process",
