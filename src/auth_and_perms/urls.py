...
from auth_and_perms.api.viewsets import (
    RolAPI,
    UpdateRolOrganizationProfilePermission,
    OrganizationAPI,
    UserLaboratoryOrganization,
    UserInOrganization,
    DeleteUserFromContenttypeViewSet,
    ProfileToContenttypeObjectAPI,
    UpdateGroupsByProfile,
...
routes.register(
    "extuserinorgrol", ExternalUserToOrganizationViewSet, "api-extuserinorg"
)
routes.register(
    "deluserorgcontt", DeleteUserFromContenttypeViewSet, "api-deluserorgcontt"
)
routes.register(
    "relusertocontenttype", ProfileToContenttypeObjectAPI, "api-relusertocontenttype"
)
routes.register(
...
urlpatterns = [
    path(
        ...
        name="select_organization_by_user",
    ),
    path("api/", include(routes.urls)),
    path(
        "switch_user/<int:org_pk>/<int:pk>",
        add_user_impostor,
        name="change_to_impostor",
    ),
    ...
    path(
        ...
        name="check_signature_window_status_register",
    ),
    ...
    path(
        "organization/manage/users/add/<int:pk>/",
        orgstruct.AddUser.as_view(),
        name="add_user",
    ),
    path(
        "organization/manage/rols/add/",
        orgstruct.add_rol_by_laboratory,
        name="add_rol_by_laboratory",
    ),
    path(
        "organization/manage/rols/list/<int:org_pk>/",
        orgstruct.ListRolByOrganization.as_view(),
        name="list_rol_by_org",
    ),
    path(
        "organization/manage/rols/del/<int:org_pk>/<int:pk>",
        orgstruct.DeleteRolByOrganization.as_view(),
        name="del_rol_by_org",
    ),
    path(
        "organization/manage/rols/copy/<int:pk>/", orgstruct.copy_rols, name="copy_rols"
    ),
    path(
        "organization/manage/relorgcont/add/",
        orgstruct.add_contenttype_to_org,
        name="add_contenttype_to_org",
    ),
    path("digitalsignature/notify", SignDataRequestViewSet.as_view({"post": "create"})),
    path(
        "update_groups_by_profile/",
        UpdateGroupsByProfile.as_view(),
        name="api_update_groups_by_profile",
    ),
    path(
