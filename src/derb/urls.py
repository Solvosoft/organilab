...
urlpatterns = [
    ...
    path('api/informView/', SerializedViews.InformView.as_view(), name='api_inform_view'),
    path('api/laboratoryView/', SerializedViews.LaboratorytView.as_view(), name='api_laboratory'),
