...
class Tutorial(models.Model):
    ...
    auto_start = models.BooleanField(
        ...
        help_text=_("Start automatically on first visit "
                    "(if user has tutorials enabled)")
    )
...
class TutorialStep(models.Model):
    ...
    tutorial = models.ForeignKey(
        Tutorial, related_name='steps', on_delete=models.CASCADE,
        verbose_name=_("Tutorial")
    )
    ...
    content = models.TextField(
        ...
        help_text=_("Supports HTML")
    )
    step_type = models.CharField(
        max_length=10, choices=STEP_TYPE_CHOICES, default='MODAL',
    ...
    position = models.CharField(
        max_length=10, choices=POSITION_CHOICES, default='bottom',
    ...
    image = models.ImageField(
        blank=True, null=True, upload_to='tutorial_images/',
...
class TutorialProgress(models.Model):
    ...
    dismissed = models.BooleanField(
        default=False, verbose_name=_("Dismissed"),
