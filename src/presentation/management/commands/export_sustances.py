    ...
    def handle(self, *args, **options):
        ...
        for instance in instances:
            ...
            if instance["fields"]["security_sheet"]:
                ...
                instance["fields"]["security_sheet"] = load_security_sheet(
                    instance["fields"]["security_sheet"]
                )
                instance["fields"]["iarc"] = get_catalog(instance["fields"]["iarc"])
                instance["fields"]["imdg"] = get_catalog(instance["fields"]["imdg"])

                instance["fields"]["precursor_type"] = get_catalog(
                    instance["fields"]["precursor_type"]
                )

                instance["fields"]["white_organ"] = get_catalog(
                    instance["fields"]["white_organ"]
                )  # M
                instance["fields"]["ue_code"] = get_catalog(
                    instance["fields"]["ue_code"]
                )
                instance["fields"]["nfpa"] = get_catalog(instance["fields"]["nfpa"])
                instance["fields"]["storage_class"] = get_catalog(
                    instance["fields"]["storage_class"]
                )
