...
class MyProcedureSeleniumTest(SeleniumBase):
    ...
    def test_view_my_procedure(self):
        path_list = self.path_base + [
            {
                "path": "/html/body/div[1]/div[1]/div[3]/div/div[1]/div/div/div/h1/span",
    ...
    def test_myprocedure_reservation(self):
        set_initial_date = (
            """document.querySelector('#id_initial_date').value='02/05/2024 14:36 PM'"""
        )
        set_final_date = (
            """document.querySelector('#id_final_date').value='02/06/2024 01:00 AM'"""
        )
        path_list = self.path_base + [
            {
            ...
            {
                "path": "/html/body/div[1]/div[1]/div[3]/div/div[3]/div/div/div[2]/form/div[2]/div/span/i",
                "extra_action": "script",
    ...
    def test_update_observation_my_procedure(self):
        path_list = self.path_base + [
            ...
            {
                "path": "/html/body/div[4]/div/div[2]/textarea",
