...
urlpatterns = [
    ...
    url(r'academic/substance/provider$', add_sga_provider,name='add_sga_provider'),
    url(r'academic/substance/get_security_leaf/(?P<substance>\d+)$', security_leaf_pdf,name='security_leaf_pdf'),
]
