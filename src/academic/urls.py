...
urlpatterns = [
    ...
    path('procedure_list/<int:pk>/', ProcedureListView.as_view(), name='procedure_list'),
    path('procedure_create/lab/<int:lab_pk>/', ProcedureCreateView.as_view(), name='procedure_create'),
    ...
    path('procedure/<int:pk>/step/', ProcedureStepCreateView.as_view(), name='procedure_step'),
    path('step/<int:pk>/lab/<int:lab_pk>/update/', ProcedureStepUpdateView.as_view(), name='update_step'),
