...
from academic.views import (
    ...
    create_my_procedures,
    remove_my_procedure,
    complete_my_procedure,
)
...
procedure_url = [
    ...
    path("procedure_detail/<int:pk>/", procedureStepDetail, name="procedure_detail"),
    path(
        "procedure/<int:pk>/step/",
        ProcedureStepCreateView.as_view(),
        name="procedure_step",
    ),
    path(
...
my_procedure_url = [
    ...
    path("remove_procedure/<int:pk>/", remove_my_procedure, name="remove_my_procedure"),
    path(
        "complete_procedure/<int:pk>/",
        complete_my_procedure,
