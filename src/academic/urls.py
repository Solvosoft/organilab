...
urlpatterns = [
    ...
    path('academic/sustance/<str:organilabcontext>/', create_edit_sustance, name='create_sustance'),
    path('academic/update_substance/<str:organilabcontext>/<int:pk>/', create_edit_sustance, name='update_substance'),
    path('academic/get_substance/<str:organilabcontext>/', get_substances, name='get_substance'),
    path('academic/approved_substance/<str:organilabcontext>/', get_list_substances, name='approved_substance'),
    path('academic/accept_substance/<str:organilabcontext>/<int:pk>/', approve_substances, name='accept_substance'),
    path('academic/delete_substance/<str:organilabcontext>/<int:pk>/', delete_substance, name='delete_substance'),
    path('academic/detail_substance/<str:organilabcontext>/<int:pk>/', detail_substance, name='detail_substance'),
    path('academic/substance/step_one/<str:organilabcontext>/<int:pk>/', create_edit_sustance, name='step_one'),
