...
class MyProcedure(AbstractOrganizationRef):
    ...
    custom_procedure = models.ForeignKey(
        Procedure,
        blank=True,
        null=True,
...
class ProcedureStep(models.Model, HTMLPresentation):
    procedure = models.ForeignKey(
        Procedure, verbose_name=_("Procedure"), on_delete=models.CASCADE
    )
...
class CommentProcedureStep(models.Model):
    ...
    my_procedure = models.ForeignKey(
        MyProcedure,
        blank=True,
        null=True,
        on_delete=models.CASCADE,
...
class ProcedureRequiredObject(models.Model):
    ...
    object = models.ForeignKey(
        Object, verbose_name=_("Object"), on_delete=models.CASCADE
    )
    ...
    def __str__(self):
        return "%s %.2f %s" % (self.object, self.quantity, str(self.measurement_unit))
