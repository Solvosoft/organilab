...
@register_lookups(prefix="custom_procedure_template", basename="custom_procedure_template")
class ProcedureGModelLookup(BaseSelect2View):
    ...
    def get_queryset(self):
        ...
        if self.org_pk:
            ...
            queryset = queryset.filter(object_id__in=organizations,
    ...
    def list(self, request, *args, **kwargs):
        ...
        self.serializer = ValidateUserAccessOrgSerializer(data= request.GET, context= {"user":request.user})
