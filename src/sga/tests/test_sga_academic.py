...
class SGAAcademicTest(TestCase):
    ...
    def test_add_warning_word(self):
        ...
        self.assertEqual(response_get.context['url'],
                         reverse('sga:add_warning_word', kwargs=self.url_attr))
        self.assertEqual(response_get.context['view_url'],
    ...
    def test_add_prudence_advice(self):
        ...
        response_pos = self.client.post(
            reverse('sga:add_prudence_advice', kwargs=self.url_attr), data=data,
            follow=True)
        self.assertEqual(response_pos.status_code, 200)
    ...
    def test_get_update_warning_word(self):
        ...
        self.assertEqual(response_get.status_code, 200)
        self.assertEqual(response_get.context['url'],
                         reverse('sga:update_warning_word', kwargs=url))
        self.assertEqual(response_get.context['view_url'],
                         reverse('sga:warning_words', kwargs=self.url_attr))
    ...
    def test_post_update_warning_word(self):
        ...
        response_pos = self.client.post(reverse('sga:update_warning_word', kwargs=url),
    ...
    def test_add_provider(self):
        ...
        response_pos = self.client.post(reverse('sga:add_sga_provider', kwargs=url),
                                        data, follow=True)
        self.assertEqual(response_pos.status_code, 200)
