...
from .views.danger_substance.views import (
    danger_substance_view,
...
router.register(
    "api_reviewsubstance", ReviewSubstanceViewSet, basename="api-reviewsubstance"
)
...
router.register(
    "api_danger_substance", DangerSubstanceViewSet, basename="api-danger-substance"
)
router.register(
    "api_danger_substance_category",
    DangerSubstanceCategoryViewSet,
...
urlpatterns = [
    ...
    path(
        "barcode/<str:code>/",
        editor.get_barcode_from_number,
    ...
    path(
        "update_substance/<int:pk>/",
        substance.create_edit_sustance,
        name="update_substance",
    ),
    path(
        "delete_substance/<int:pk>/",
        substance.delete_substance,
    ...
    path(
        "sgalabel/get_recipient_size/<int:pk>",
        editor.get_recipient_size,
        name="get_recipient_size",
    ),
    path(
        "sgalabel/get_sgacomplement_by_substance/<int:pk>",
        editor.get_sgacomplement_by_substance,
        name="get_sgacomplement_by_substance",
    ),
    path("sgalabel/create/", editor.create_sgalabel, name="sgalabel_create"),
    path(
        "sgalabel/step_one/<int:pk>", editor.sgalabel_step_one, name="sgalabel_step_one"
    ),
    path(
        "sgalabel/step_two/<int:pk>", editor.sgalabel_step_two, name="sgalabel_step_two"
    ),
    path("get_substance/", substance.get_substances, name="get_substance"),
    path(
        "approved_substance/", substance.get_list_substances, name="approved_substance"
    ),
    path(
        "accept_substance/<int:pk>/",
        substance.approve_substances,
    ...
    path(
        "substance/danger_indications/",
        substance.view_danger_indications,
        name="danger_indications",
    ),
    path(
        "substance/warning_words/", substance.view_warning_words, name="warning_words"
    ),
    path(
        "substance/prudence_advices/",
        substance.view_prudence_advices,
        name="prudence_advices",
    ),
    path(
        "substance/add_danger_indication/",
        substance.add_sga_complements,
        kwargs={"element": "danger"},
        name="add_danger_indication",
    ),
    path(
        "substance/add_warning_words/",
        substance.add_sga_complements,
        kwargs={"element": "warning"},
        name="add_warning_word",
    ),
    path(
        "substance/add_prudence_advice/",
        substance.add_sga_complements,
        kwargs={"element": "prudence"},
        name="add_prudence_advice",
    ),
    path(
        "substance/add_observation/<int:substance>/",
        substance.add_observation,
        name="add_observation",
    ),
    path(
        "substance/update_observation/",
        substance.update_observation,
        name="update_observation",
    ),
    path(
        "substance/deleta_observation/",
        substance.delete_observation,
        name="delete_observation",
    ),
    path(
        "substance/update_danger_indication/<str:pk>/",
        substance.change_danger_indication,
        name="update_danger_indication",
    ),
    path(
        "substance/update_warning_words/<int:pk>/",
        substance.change_warning_word,
        name="update_warning_word",
    ),
    path(
        "substance/update_prudence_advice/<int:pk>/",
        substance.change_prudence_advice,
    ...
    path(
        "danger_subtance_category/",
        danger_substance_category_view,
        name="danger_substance_category",
    ),
]
