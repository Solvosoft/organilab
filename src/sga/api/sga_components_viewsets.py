...
from sga.views.substance.forms import (
    WarningWordForm,
...
class WarningWordTableView(mixins.ListModelMixin, viewsets.GenericViewSet):
    ...
    permissions_by_endpoint = {"list": ["sga.view_warningword"]}
...
class WarningWordAPI(mixins.ListModelMixin, viewsets.GenericViewSet):
    ...
    def create(self, request, org_pk, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return JsonResponse(
                {"detail": _("Item created successfully.")},
    ...
    def update(self, request, org_pk, pk=None, *args, **kwargs):
        ...
        if pk:
            ...
            if form.is_valid():
                ...
                return JsonResponse(
                    {"detail": _("Item updated successfully.")},
    ...
    def destroy(self, request, org_pk, pk=None, *args, **kwargs):
        ...
        if pk:
            ...
            return JsonResponse(
                {"detail": _("Item deleted successfully.")}, status=status.HTTP_200_OK
            )
...
class DangerIndicationTableView(mixins.ListModelMixin, viewsets.GenericViewSet):
    ...
    permissions_by_endpoint = {"list": ["sga.view_dangerindication"]}
