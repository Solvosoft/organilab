...
from .forms import ObservacionForm, SecurityLeafForm, SustanceObjectForm, SustanceCharacteristicsForm, \
    ReviewSubstanceForm
...
def detail_substance(request, org_pk, pk):
    ...
    context = {
        ...
        'step':step,
        'url': reverse('sga:add_observation',kwargs={'org_pk': org_pk, 'substance':pk}),
        'org_pk': org_pk
    }
...
def change_warning_word(request, org_pk, pk):
    ...
    if request.method =='POST':
        ...
        context = {
            ...
            'url':reverse('sga:update_warning_word', kwargs={'org_pk': org_pk, 'pk':instance.pk}),
            'org_pk': org_pk
        }
    return render(request, 'sga/substance/sga_components.html', context=context)
...
def change_prudence_advice(request, *args, **kwargs):
    ...
    if request.method =='POST':
        ...
        if form.is_valid():
            ...
            return redirect(reverse('sga:prudence_advices', kwargs={'org_pk': org_pk,}))
    else:
        ...
        context = {
            ...
            'url':reverse('sga:update_prudence_advice', kwargs={'org_pk': org_pk, 'pk':instance.pk})
        }
    return render(request, 'sga/substance/sga_components.html', context=context)
...
def change_danger_indication(request, org_pk, pk):
    ...
    if request.method =='POST':
        ...
        if form.is_valid():
            ...
            return redirect(reverse('sga:danger_indications', kwargs={'org_pk': org_pk}))
    else:
        ...
        context = {
            ...
            'url':reverse('sga:update_danger_indication', kwargs={'org_pk': org_pk, 'pk':instance.pk}),
            'org_pk': org_pk
        }
    return render(request, 'sga/substance/sga_components.html', context=context)
