...
@method_decorator(
    permission_required("laboratory.add_informscheduler", raise_exception=True),
    name="dispatch",
)
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("laboratory.change_informscheduler", raise_exception=True),
    name="dispatch",
)
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("laboratory.view_informscheduler", raise_exception=True),
    name="dispatch",
)
