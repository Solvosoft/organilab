    ...
    def get(self, request, *args, **kwargs):
        ...
        if "lab_pk" in kwargs:
            ...
            self.laboratory = get_object_or_404(
                Laboratory.objects.using(settings.READONLY_DATABASE), pk=self.lab
            )
            organization_can_change_laboratory(
...
class ReportListView(djListView):
    ...
    def get_pdf(self, request, *args, **kwargs):
        ...
        response["Content-Disposition"] = (
            'attachment; filename="%s.pdf"' % self.get_file_name(request)
        )
        return response
    ...
    def get_xls(self, request, *args, **kwargs):
        ...
        return django_excel.make_response_from_array(
            ...
            file_format,
            file_name="%s.xls" % self.get_file_name(request),
        )
    ...
    def get_xlsx(self, request, *args, **kwargs):
        ...
        return django_excel.make_response_from_array(
            self.get_book(context),
            file_format,
            file_name="%s.xlsx" % self.get_file_name(request),
        )
    ...
    def get_ods(self, request, *args, **kwargs):
        ...
        return django_excel.make_response_from_array(
            self.get_book(context),
            file_format,
            file_name="%s.ods" % self.get_file_name(request),
        )
