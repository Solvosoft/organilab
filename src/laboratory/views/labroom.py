...
class LaboratoryRoomDelete(DeleteView):
    ...
    def get_success_url(self):
        return reverse_lazy(
            "laboratory:rooms_create", args=(self.org, self.kwargs.get("lab_pk"))
        )
...
class LaboratoryRoomReportView(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super(LaboratoryRoomReportView, self).get_context_data(**kwargs)
    ...
    for labroom in lab.laboratoryroom_set.all():
        ...
        for furniture in labroom.furniture_set.all():
            ...
            for shelf in furniture.shelf_set.all():
                ...
                update_qr_instance(
                    baseurl + labroom_url + furnitureurl + shelfurl, shelf, org_pk
                )
