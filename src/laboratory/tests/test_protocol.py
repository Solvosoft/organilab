...
class ProtocolViewTest(BaseLaboratorySetUpTest):
    ...
    def setUp(self):
        ...
        self.permissions = ProfilePermission.objects.filter(content_type__app_label='laboratory',object_id=self.lab.pk,
    ...
    def test_create_protocol(self):
        ...
        data = {
            ...
            "file": json.dumps({'token': self.chfile.upload_id, 'name': 'protocol.pdf', 'display_text': 'protocol_test.pdf'})
        }
