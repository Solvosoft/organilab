...
class ShelfObjectStatusTest(BaseShelfobjectStatusSetUpTest):
    def test_update_status(self):
        ...
        catalog = Catalog.objects.create(
            key="shelfobject_status", description="Buen estado"
        )
        data = {"shelfobject": 5, "status": catalog.pk, "description": "Change Status"}
        url = reverse(
            "laboratory:api-shelfobject-update-status",
        ...
        self.assertTrue(
            ...
            == _("The object status was updated successfully")
        )
    ...
    def test_update_status_not_permission(self):
        ...
        data = {"shelfobject": 4, "status": catalog.pk, "description": "Change Status"}
        url = reverse(
            "laboratory:api-shelfobject-update-status",
        ...
        self.assertTrue(shelfobject.status is None)
        self.assertTrue(
            json.loads(response.content)["detail"]
    ...
    def test_update_status_form_error(self):
        ...
        data = {"shelfobject": 4, "description": "Change Status"}
        url = reverse(
            "laboratory:api-shelfobject-update-status",
            kwargs={"org_pk": self.org_pk, "lab_pk": self.lab.pk, "pk": 4},
        )
        ...
        self.assertTrue(shelfobject.status is None)
        self.assertTrue(
            json.loads(response.content)["errors"]["status"][0]
    ...
    def test_update_status_error(self):
        ...
        """
        shelfobject = ShelfObject.objects.get(pk=4)
        data = {"shelfobject": 4, "status": 157, "description": "Change Status"}
        url = reverse(
            "laboratory:api-shelfobject-update-status",
            kwargs={"org_pk": self.org_pk, "lab_pk": self.lab.pk, "pk": 4},
        )
    ...
    def test_update_status_not_laboratory(self):
        ...
        data = {"shelfobject": 4, "status": 1, "description": "Change Status"}
        url = reverse(
            "laboratory:api-shelfobject-update-status",
    ...
    def test_update_status_empty_description(self):
        ...
        data = {"shelfobject": 4, "status": catalog.pk, "description": ""}
        url = reverse(
            "laboratory:api-shelfobject-update-status",
            kwargs={"org_pk": self.org_pk, "lab_pk": self.lab.pk, "pk": 4},
        )
        ...
        self.assertTrue(
            json.loads(response.content)["errors"]["description"][0]
    ...
    def test_update_status_shelfobject_other_lab(self):
        ...
        self.assertTrue(Catalog.objects.filter(key="shelfobject_status").count() == 2)
        self.assertTrue(
            json.loads(response.content)["errors"]["shelf_object"][0]
            == "Object does not exist in the laboratory."
        )
