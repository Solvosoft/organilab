...
class ShelfObjectReserveByLabViewTest(ShelfObjectSetUp):
    ...
    *** Reserve shelf object by laboratory view ***
    ...
    def setUp(self):
        ...
        self.url = reverse(
            "laboratory:api-shelfobject-reserve",
...
class ShelfObjectReserveByProcedureViewTest(ShelfObjectSetUp):
    ...
    *** Reserve shelf object by procedure ***
    ...
    def setUp(self):
        ...
        self.objects_list = ProcedureRequiredObject.objects.filter(
            step__procedure__pk=self.data["procedure"]
    ...
    def check_reservedproducts(self, step_objects, required_state):
        for step_obj in step_objects:
            self.filters.update({"shelf_object__object__pk": step_obj.object.pk})
    ...
    def test_shelfobject_reserve_by_procedure_case1(self):
        ...
        self.assertFalse(
            self.validate_reservation_dates(
                self.initial_date.date(), self.final_date.date()
            )
        )
