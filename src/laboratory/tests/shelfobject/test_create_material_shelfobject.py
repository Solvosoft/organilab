...
class CreateShelfobjectTest(TestCase):
    ...
    def test_create_shelfobject_material(self):
        ...
        MaterialCapacity.objects.create(
            object=material, capacity=200, capacity_measurement_unit=unit
        )
        data = {
            "shelf": 13,
            "object": material.pk,
        ...
        self.assertTrue(
            ShelfObject.objects.filter(shelf__pk=13).count() > shelfobject_count
        )
    ...
    def test_create_shelfobject_material_over_capacity(self):
        ...
        self.assertTrue(
            ...
            == "Quantity cannot be greater than the container capacity limit: 200.0."
        )
        self.assertTrue(
            ShelfObject.objects.filter(shelf__pk=13).count() == shelfobject_count
        )
    ...
    def test_create_shelfobject_material_other_capacity_unit(self):
        ...
        self.assertTrue(
            ...
            == "Measurement unit cannot be different than the container object measurement unit: Unidades."
        )
        self.assertTrue(
            ShelfObject.objects.filter(shelf__pk=13).count() == shelfobject_count
        )
