...
from laboratory.models import Laboratory, ShelfObjectObservation, ShelfObject, Catalog, \
    UserOrganization, \
    OrganizationStructure, Shelf, Object, ShelfObjectEquipmentCharacteristics
...
class EditShelfobject(TestCase):
    ...
    def setUp(self):
        ...
        create_status_rol = Rol.objects.create(name="Test edit shelfobject", color="#FFF")
    ...
    def test_edit_shelfobject_equipment_without_characterics(self):
        ...
        pre_shelfobject= hasattr(pre_shelfobject, "shelfobjectequipmentcharacteristics")

        url = reverse("laboratory:api-shelfobject-edit-equipment-shelfobject",  kwargs={"org_pk": self.org_pk, "lab_pk": self.lab.pk, 'pk':13})
        ...
        self.assertTrue(json.loads(response.content)['detail'] == _('Shelfobject was updated successfully.'))
    ...
    def test_create_shelfobject_other_lab(self):
        ...
        url = reverse("laboratory:api-shelfobject-edit-equipment-shelfobject",  kwargs={"org_pk": self.org_pk, "lab_pk": lab.pk, 'pk':13})
    ...
    def test_edit_shelfobject_other_organization(self):
        ...
        url = reverse("laboratory:api-shelfobject-edit-equipment-shelfobject",  kwargs={"org_pk": 4, "lab_pk": self.lab.pk, 'pk':13})
    ...
    def test_edit_shelfobject_user_forbidden(self):
        self.client.logout()
        url = reverse("laboratory:api-shelfobject-edit-equipment-shelfobject",
