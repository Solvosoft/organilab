...
class EditShelfObjectEquipment(ShelfObjectEquipmentSeleniumTest):
    ...
    def test_edit_shelfobject_equipment(self):
        path_list = [
            ...
            {"path": "//*[@id='id_description']", "scroll": "window.scrollTo(0, 250)"},
            ...
            {"path": "/html/body/div[1]/div/div[3]/div/div/div[2]/div[2]/div[1]/form/div[5]/div/span/span[1]/span/span/textarea"},
            {"path": "/html/body/span/span/span/ul/li[4]"},
