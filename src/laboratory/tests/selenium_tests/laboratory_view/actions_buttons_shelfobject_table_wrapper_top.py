...
class CreateShelfObject(LaboratoryViewSeleniumTest):
    ...
    def create_reactive(
        ...
        path_list = (
            ...
            + [
                ...
                {
                    "path": "//*[@id='reactive_form']/div[%d]/div/span/span/span"
                    % select_container_position
                },
            ]
            + self.create_shelfobject_reative_end
    ...
    def test_create_shelfobject_reactive_with_use_selected_container(self):
        self.create_reactive(5, 7, "use_selected", ins_position="[2]")
    ...
    def test_create_shelfobject_equipment(self):
        ...
        path_list = self.path_base + [
            ...
            {
                "path": "/html/body/div[1]/div/div[3]/div/div/div[11]/div/div/div[2]/div/div[2]/form/div[8]/div/div/input",
            ...
            {
                "path": "/html/body/div[1]/div/div[3]/div/div/div[11]/div/div/div[2]/div/div[2]/form/div[10]/div/span",
                "scroll": "$('#equipment_modal').scrollTop(600)",
            },
            {
