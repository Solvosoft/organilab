...
class EquipmentDropdowmSeleniumTest(ObjectSeleniumBase):
    ...
    def test_view_equipment(self):
        ...
        self.create_gif_by_change_focus_tab(
            general_path_list, ["equipmentlistview"], "view_equipments"
        )
    ...
    def test_add_object_equipment(self):
        ...
        path_list = [
            ...
            {
                "path": "//*[@id='create_obj_form']/div[5]/div/textarea",
            ...
            {
                "path": "//*[@id='create_obj_form']/div[7]/div/input",
            ...
            {
                "path": "//*[@id='create_obj_form']/div[8]/div/input",
            ...
            {
                "path": "//*[@id='create_obj_form']/div[17]/div/input",
        ...
        general_path_list = [self.equipment_path, path_list]
        self.create_gif_by_change_focus_tab(
            general_path_list, ["equipmentlistview"], "add_equipment_object"
        )
    ...
    def test_edit_object_equipment(self):
        ...
        general_path_list = [self.equipment_path, path_list]
        self.create_gif_by_change_focus_tab(
            general_path_list, ["equipmentlistview"], "update_equipment_object"
        )
    ...
    def test_delete_equipment(self):
        ...
        general_path_list = [self.equipment_path, path_list]
        self.create_gif_by_change_focus_tab(
            general_path_list, ["equipmentlistview"], "delete_equipment_object"
        )
    ...
    def test_search_equipment_object(self):
        ...
        general_search_input = (
            "//*[@id='equipment_table_wrapper']/div/div/div/label/input"
        )
        ...
        general_path_list = [self.equipment_path, path_list]
        self.create_gif_by_change_focus_tab(
            general_path_list, ["equipmentlistview"], "search_equipment_object"
        )
