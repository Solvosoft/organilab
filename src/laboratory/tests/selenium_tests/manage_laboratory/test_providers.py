...
class ProviderSeleniumTest(SeleniumBase):
    ...
    def test_view_providers(self):
        path_list = self.path_base+[
            {"path": ".//div[1]/div/div[3]/div/div/div[1]/h1", "screenshot_name": "view_provider"},
            ]
    ...
    def test_add_provider(self):
        path_list = self.path_base+[
            ...
            {"path": "//*[@id='id_name']", "extra_action": "setvalue", "value": "Fanal"},
            {"path": "//*[@id='id_phone_number']",  "extra_action": "clearinput"},
            {"path": "//*[@id='id_phone_number']",  "extra_action": "setvalue", "value": "(506)2234-0000"},
            {"path": "//*[@id='id_email']",  "extra_action": "clearinput"},
            {"path": "//*[@id='id_email']",  "extra_action": "setvalue", "value": "kcb"},
            {"path": "//*[@id='id_email']",  "extra_action": "move_cursor_end",
             "reduce_length": 3},
            {"path": "//*[@id='id_email']",  "extra_action": "setvalue", "value": "@gmail.com"},
            {"path": "//*[@id='id_legal_identity']",  "extra_action": "clearinput"},
            {"path": "//*[@id='id_legal_identity']",  "extra_action": "setvalue", "value":"123456879"},
            ]
