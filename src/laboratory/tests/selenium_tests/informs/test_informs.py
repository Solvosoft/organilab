...
class InformSeleniumTest(InformSeleniumBase):
    ...
    def test_add_inform(self):
        ...
        path_list = self.path_base + [
            ...
            {
                "path": "/html/body/div[1]/div/div[3]/div/div/div[2]/div/div/div[2]/form/div[1]/div/input",
    ...
    def test_review_inform(self):
        path_list = self.path_base + [
            ...
            {
                "path": "/html/body/div[1]/div/div[3]/div/div/div/div[2]/div[1]/form/div/div/div[1]/div[1]/div[1]/input",
            ...
            {
                "path": "/html/body/div[1]/div/div[3]/div/div/div/div[2]/div[1]/form/div/div/div[1]/div[2]/div[1]/textarea",
                "extra_action": "clearinput",
            },
            {
                "path": "/html/body/div[1]/div/div[3]/div/div/div/div[2]/div[1]/form/div/div/div[1]/div[2]/div[1]/textarea",
    ...
    def test_crud_inform_observation(self):
        path_list = self.path_base + [
            ...
            {
                "path": "/html/body/div[3]/div/div[2]/textarea",
                "extra_action": "setvalue",
