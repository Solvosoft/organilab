...
class EquipmentViewTest(BaseLaboratorySetUpTest):
    ...
    def setUp(self):
        ...
        self.url_equipment_view = reverse(
            "laboratory:equipment_list", kwargs=self.kwargs
        )
        self.url_equipment_list = reverse(
            "laboratory:api-equipment-list", kwargs=self.kwargs
        )
        ...
        self.user_without_perms = (
            get_user_model().objects.filter(username="tuwp").first()
        )
        self.client2 = Client()
        ...
        filters = Q(
            organization__in=get_pk_org_ancestors_decendants(self.user, self.org.pk),
            is_public=True,
    ...
    def test_view_equipment_list_user_with_perms(self):
        ...
        response = self.client.get(
            self.url_equipment_list, content_type="application/json"
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_create_equipment_without_features_user_with_perms(self):
        ...
        del data["features"]
        response = self.client.post(
            self.url_equipment_list, data=data, content_type="application/json"
        )
    ...
    def test_update_equipment_without_features_user_with_perms(self):
        ...
        data["features"] = []
        response = self.client.put(
            self.url_equipment_update, data=data, content_type="application/json"
        )
        self.assertEqual(response.status_code, 400)
    ...
    def test_delete_equipment_user_with_perms(self):
        ...
        response = self.client.delete(
            self.url_equipment_destroy1, content_type="application/json"
        )
        self.assertEqual(response.status_code, 204)
    ...
    def test_delete_equipment_with_different_object_org_user_with_perms(self):
        ...
        response = self.client.delete(
            self.url_equipment_destroy3, content_type="application/json"
        )
    ...
    def test_delete_equipment_user_without_perms(self):
        ...
        response = self.client2.delete(
            self.url_equipment_destroy2, content_type="application/json"
        )
        self.assertEqual(response.status_code, 403)
