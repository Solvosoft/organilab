...
class ShelfObjectCreateMethods:
    ...
    def create_reactive(self, serializer, limits_serializer):
        ...
        new_container = move_shelfobject_partial_quantity_to(serializer.validated_data['container'], organization_id, laboratory_id, 
        ...
        log_object_change(creator, laboratory_id, shelfobject, 0, shelfobject.quantity, '', 0, "Create", create=True)
...
class ShelfObjectViewSet(viewsets.GenericViewSet):
    ...
    def transfer_out(self, request, org_pk, lab_pk, **kwargs):
        ...
        return JsonResponse({"detail": _("The transfer out was saved successfully.")}, status=status.HTTP_200_OK)
