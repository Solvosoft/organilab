# Generated by Django 4.1.10 on 2024-03-14 21:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intern_people_receive_training', models.ManyToManyField(to='auth_and_perms.profile', verbose_name='Internal participants in training')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maintenance_observation', models.TextField(blank=True, null=True, verbose_name='Observation')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('organization', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='laboratory.organizationstructure')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_update', models.DateTimeField(auto_now=True)),
                ('observation', models.TextField(blank=True, null=True, verbose_name='Observation')),
                ('calibrate_name', models.CharField(blank=True, max_length=100, verbose_name='Name of Calibrator')),
