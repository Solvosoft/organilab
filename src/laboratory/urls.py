...
from laboratory.api.shelfobject import (
    ShelfObjectMaintanenceViewset,
    ShelfObjectLogViewset,
    ShelfObjectCalibrateViewset,
    ShelfObjectGuaranteeViewset,
...
from laboratory.views.catalogs import (
...
from sga.api.sga_components_viewsets import (
    ...
    DangerIndicationAPI,
    DangerIndicationTableView,
    PrudenceAdviceAPI,
    PrudenceAdviceTableView,
)
...
from laboratory.api.views import (
    ...
    InformViewSet,
    ShelfObjectAPI,
    ShelfObjectGraphicAPI,
    ShelfList,
    ShelfObjectObservationView,
...
organization_urls_org_pk = [
    path(
        "my_reservations/<int:lab_pk>",
        MyReservationView.as_view(),
        name="my_reservations",
    ),
    path("labindex/<int:lab_pk>", views.lab_index, name="labindex"),
    path(
        "laboratory/<int:pk>/edit/",
        laboratory.LaboratoryEdit.as_view(),
        name="laboratory_update",
    ),
    path(
        "create_lab/", laboratory.CreateLaboratoryFormView.as_view(), name="create_lab"
    ),
...
urlpatterns = [
    path(
        "rp/api/reservedProducts/<int:pk>/delete/",
        ApiReservedProductsCRUD.as_view(),
        name="api_reservation_delete",
    ),
    path(
        "rp/api/reservedProducts/<int:pk>/update/",
        ApiReservedProductsCRUD.as_view(),
        name="api_reservation_update",
    ),
    path(
        "r/api/reservation/",
        ApiReservationCRUD.as_view(),
        name="api_individual_reservation_create",
    ),
    path(
        "reserve_object/<int:modelpk>",
...
lab_shelf_urls = [
    ...
    path(
        "delete/<int:pk>/<int:row>/<int:col>/", shelfs.delete_shelf, name="shelf_delete"
    ),
    path(
        "edit/<int:pk>/<int:row>/<int:col>/",
        shelfs.ShelfEdit.as_view(),
        name="shelf_edit",
    ),
...
lab_rooms_urls = [
    ...
    path(
        ...
        labroom.rebuild_laboratory_qr,
        name="rebuild_laboratory_qr",
    ),
    path(
        "<int:pk>/delete", labroom.LaboratoryRoomDelete.as_view(), name="rooms_delete"
    ),
...
lab_furniture_urls = [
    ...
    path(
        "create/<int:labroom>/",
        furniture.FurnitureCreateView.as_view(),
        name="furniture_create",
    ),
    path(
        "edit/<int:pk>/",
        furniture.FurnitureUpdateView.as_view(),
        name="furniture_update",
    ),
    path(
        "delete/<int:pk>/", furniture.FurnitureDelete.as_view(), name="furniture_delete"
    ),
]
...
shelf_object_urls = [
    ...
    path(
        "delete/<int:pk>/",
        shelfobject.ShelfObjectDelete.as_view(),
        name="shelfobject_delete",
    ),
    path(
        "detail/<int:pk>/",
    ...
    path(
        "q/update/<int:pk>/",
        shelfobject.ShelfObjectSearchUpdate.as_view(),
        name="shelfobject_searchupdate",
    ),
    path(
        "get_shelfobject_limit/<int:pk>/",
        shelfobject.edit_limit_object,
        name="get_shelfobject_limit",
    ),
    path(
        "download_shelfobject_qr/<int:pk>/",
        shelfobject.download_shelfobject_qr,
        name="download_shelfobject_qr",
    ),
...
lab_reports_urls = [
    # PDF reports
    path(
        "shelf_objects/<int:pk>",
        reports.report_shelf_objects,
...
equipment_urls = [
    ...
    path(
        "instrumental/", view_instrumental_family_list, name="instrumentalfamily_list"
    ),
...
organization_urls = [
    path(
        "organization/manage/actions",
        OrganizationActionsFormview.as_view(),
...
informs_urls = [
    ...
    path(
        "add_informs/<str:content_type>/<str:model>/",
        create_informs,
        name="add_informs",
    ),
...
catalogs_urls = [
    path(
        ...
        kwargs={"key": "furniture_type"},
        name="add_furniture_type_catalog",
    ),
    path(
        "shelf/container_type",
        furniture.add_catalog,
        kwargs={"key": "container_type"},
        name="add_shelf_type_catalog",
    ),
    path(
        "shelf/shelfobject_status",
        furniture.add_catalog,
        kwargs={"key": "shelfobject_status"},
        name="add_shelfobject_status",
    ),
    path(
        "add/structure/type/",
        furniture.add_catalog,
...
informs_period_urls = [
    ...
    path(
        "add/", inform_period.InformSchedulerAdd.as_view(), name="add_period_scheduler"
    ),
    path(
        "edit/<int:pk>/",
        inform_period.InformSchedulerEdit.as_view(),
        name="edit_period_scheduler",
    ),
    path(
        "detail/<int:pk>/",
        inform_period.InformSchedulerDetail.as_view(),
        name="detail_period_scheduler",
    ),
]
...
user_register_qr = [
    ...
    path(
        "manage/<int:pk>/",
        laboratory.manage_register_qr,
        name="manage_register_user_qr",
    ),
    path(
        "delete/<int:pk>/",
        laboratory.RegisterUserQRDeleteView.as_view(),
        name="delete_register_user_qr",
    ),
    path(
        "download/<int:pk>/",
        laboratory.get_pdf_register_user_qr,
        name="download_register_user_qr",
    ),
    path(
        "logentry/<int:pk>/",
        laboratory.get_logentry_from_registeruserqr,
        name="logentry_register_user_qr",
    ),
    path(
        "login/<int:pk>/",
        laboratory.login_register_user_qr,
        name="login_register_user_qr",
    ),
    path("create_user_qr/<int:pk>", laboratory.create_user_qr, name="create_user_qr"),
    path(
        "create_user_qr/<int:pk>/<int:user>",
        laboratory.create_user_qr,
        name="create_user_qr",
    ),
    path(
        "redirect_user_to_labindex/<int:pk>/",
        laboratory.redirect_user_to_labindex,
        name="redirect_user_to_labindex",
    ),
]
...
stepcommentsrouter.register(
    "api_my_procedure", ProcedureStepCommentAPI, basename="api-my-procedure"
)
stepcommentsrouter.register(
    "api_procedure_comments",
    ProcedureStepCommentTableView,
    basename="api-procedure-comments",
)

sgacomponentsrouter = DefaultRouter()
sgacomponentsrouter.register(
    "api_warning_word", WarningWordAPI, basename="api-warning-word"
)
sgacomponentsrouter.register(
    "api_warnings_table", WarningWordTableView, basename="api-warnings-table"
)
sgacomponentsrouter.register(
    "api_danger_indication", DangerIndicationAPI, basename="api-danger-indication"
)
sgacomponentsrouter.register(
    "api_dangers_table", DangerIndicationTableView, basename="api-dangers-table"
)
sgacomponentsrouter.register(
    "api_prudence_advice", PrudenceAdviceAPI, basename="api-prudence-advice"
)
sgacomponentsrouter.register(
    "api_advices_table", PrudenceAdviceTableView, basename="api-advices-table"
)

shelfobjectrouter = DefaultRouter()
shelfobjectrouter.register(
    "api_shelfobject_table",
    ShelfObjectApi.ShelfObjectTableViewSet,
    basename="api-shelfobjecttable",
)
shelfobjectrouter.register(
...
shelfobjectmaintenance.register(
    "api_shelfobject_maintenance_list",
    ShelfObjectMaintanenceViewset,
    basename="api-shelfobject-maintenance",
)

shelfobjectlog = DefaultRouter()
shelfobjectlog.register(
    "api_shelfobject_log_list", ShelfObjectLogViewset, basename="api-shelfobject-log"
)

shelfobjectcalibrate_router = DefaultRouter()
shelfobjectcalibrate_router.register(
    "api_shelfobject_calibrate",
    ShelfObjectCalibrateViewset,
    basename="api-shelfobject-calibrate",
)

shelfobjectguarantee_router = DefaultRouter()
shelfobjectguarantee_router.register(
    "api_shelfobject_guarentee",
    ShelfObjectGuaranteeViewset,
    basename="api-shelfobject-guarantee",
)

shelfobjecttraining_router = DefaultRouter()
shelfobjecttraining_router.register(
    "api_shelfobject_training",
    ShelfObjectTrainingViewset,
    basename="api-shelfobject-training",
)
...
objectrouter.register(
    "api_equipment_list", EquipmentManagementViewset, basename="api-equipment"
)
objectrouter.register(
    "api_instrumentalfamily_list",
    InstrumentalFamilyManagementViewset,
    basename="api-instrumentalfamily",
)
objectrouter.register(
    "api_equipmenttype_list",
    EquipmentTypeManagementViewset,
    basename="api-equipmenttype",
)
objectrouter.register(
...
urlpatterns += organization_urls + [
    ...
    path(
        "lab/<int:org_pk>/<int:pk>/delete/",
        LaboratoryDeleteView.as_view(),
        name="laboratory_delete",
    ),
    path(
        "lab/<int:org_pk>/search/disposal/",
    ...
    path(
        "org/<int:org_pk>/api/shelfobject/",
        ShelfObjectAPI.as_view(),
        name="api_shelfobject",
    ),
    path(
        "org/api/shelfobject/graphic",
        ShelfObjectGraphicAPI.as_view(),
    ...
    path(
        "shelfobject/maintenance/api/<int:org_pk>/<int:lab_pk>/<int:shelfobject>/",
        include(shelfobjectmaintenance.urls),
    ),
    path(
        "shelfobject/log/api/<int:org_pk>/<int:lab_pk>/<int:shelfobject>/",
        include(shelfobjectlog.urls),
    ),
    path(
        "shelfobject/calibrate/api/<int:org_pk>/<int:lab_pk>/<int:shelfobject>/",
        include(shelfobjectcalibrate_router.urls),
    ),
    path(
        "shelfobject/guarantee/api/<int:org_pk>/<int:lab_pk>/<int:shelfobject>/",
        include(shelfobjectguarantee_router.urls),
    ),
    path(
        "shelfobject/training/api/<int:org_pk>/<int:lab_pk>/<int:shelfobject>/",
        include(shelfobjecttraining_router.urls),
    ),
    path(
        "lab/<int:org_pk>/<int:lab_pk>/shelfobject/<int:pk>/edit/",
