...
solutions_urls = [
    re_path(r'^calculator$', solutions.SolutionCalculatorView.as_view(),
        name='solution_calculator'),
    re_path(r'^$', solutions.SolutionListView.as_view(), name='solution_list'),
    re_path(r'^(?P<pk>\d+)$', solutions.SolutionDetailView.as_view(),
...
urlpatterns += sustance_urls + organization_urls + [
    ...
    re_path(r'^lab/(?P<lab_pk>\d+)/solutions/', include(solutions_urls)),
