...
class ShelfObjectReactiveForm(ShelfObjectExtraFields, forms.ModelForm, GTForm):
    ...
    class Meta:
        model = ShelfObject
        fields = ["object", "shelf", "status", "quantity", "measurement_unit", "container", "course_name",
                  "marked_as_discard", "batch", "objecttype"]
        exclude = ['laboratory_name', 'creator', 'limit_quantity', 'in_where_laboratory', 'shelf_object_url',
                   'shelf_object_qr', 'limits']
        widgets = {
