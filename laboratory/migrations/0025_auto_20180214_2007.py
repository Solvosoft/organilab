# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-02-15 02:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='laboratory.OrganizationStructure')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='assigned',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='laboratory.Laboratory'),
        ),
        migrations.AddField(
            model_name='principaltechnician',
            name='credentials',
